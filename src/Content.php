...
class Content
{
    ...
    public function __construct($content, $font = null)
    {
    ...
    {
        return json_encode($this->parseFaceContents());
    }
    ...
    public function setFont($name = '微软雅黑', $color = '000000', $size = 10, array $style = [0, 0, 0])
    {
        $this->font = [
            'name' => $name,
            'size' => $size,
